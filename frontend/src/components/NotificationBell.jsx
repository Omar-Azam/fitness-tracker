  ...
  return (
    <div ref={containerRef} className="relative">
      <button
        ...
        className="relative p-2 rounded-xl bg-slate-800 hover:bg-slate-750 text-slate-200 hover:text-white border border-slate-700/80 transition cursor-pointer"
        title="Notifications"
      >
      ...
      {isOpen && (
        <div className="absolute right-0 top-full mt-2 w-80 sm:w-96 z-50 bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl overflow-hidden max-h-[80vh] flex flex-col">
          {/* Header */}
                ...
                return (
                  <div
                    ...
                    className={`p-3.5 flex items-start gap-3 transition cursor-pointer ${
                      n.read
                        ? 'bg-slate-900/50 hover:bg-slate-800/40 text-slate-400'
                        : 'bg-slate-950/80 hover:bg-slate-800/60 text-white'
                    }`}
                  >
                    <div
                    ...
                    <div className="flex-1 min-w-0">
                      <p className={`text-xs ${n.read ? 'text-slate-300' : 'font-semibold text-white'}`}>
                        {n.message}
                      </p>

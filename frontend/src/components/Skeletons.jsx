...
export const CardSkeleton = () => (
  <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 shadow-sm dark:shadow-lg space-y-4 animate-pulse">
    ...
    <div className="space-y-2 pt-2">
      ...
      <div className="h-4 bg-slate-200/60 dark:bg-slate-800/60 rounded w-1/2" />
    </div>
...
export const StatCardSkeleton = () => (
  <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 shadow-sm dark:shadow-lg space-y-3 animate-pulse">
    <div className="flex items-center justify-between">
...
export const ChartSkeleton = () => (
  <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 shadow-sm dark:shadow-xl space-y-6 animate-pulse">
    <div className="flex items-center justify-between">
      <div className="space-y-2">
        <div className="h-5 bg-slate-200 dark:bg-slate-800 rounded w-40" />
        <div className="h-3 bg-slate-200/60 dark:bg-slate-800/60 rounded w-28" />
      </div>
      <div className="h-8 bg-slate-200 dark:bg-slate-800 rounded-xl w-32" />
    </div>
    <div className="h-64 bg-slate-50 dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800/40 rounded-xl flex items-end justify-between p-4 gap-2">
      {[40, 65, 50, 80, 70, 90, 85].map((height, i) => (
        <div
          key={i}
          style={{ height: `${height}%` }}
          className="bg-slate-200/80 dark:bg-slate-800/60 rounded-t-lg flex-1 mx-1"
        />
      ))}
    </div>
  </div>
...
export const MeasurementSkeleton = () => (
  <div className="bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800/80 rounded-2xl p-4 space-y-2 animate-pulse">
...
export const ActivityItemSkeleton = () => (
  <div className="p-3.5 rounded-xl bg-slate-50 dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800/60 flex items-center justify-between animate-pulse">
    <div className="flex items-center gap-3">
      <div className="w-8 h-8 rounded-lg bg-slate-200 dark:bg-slate-800" />
      <div className="space-y-1.5">
        <div className="h-4 bg-slate-200 dark:bg-slate-800 rounded w-28" />
        <div className="h-3 bg-slate-200/60 dark:bg-slate-800/60 rounded w-16" />
      </div>
    </div>

          ...
          <div className="max-w-md w-full bg-slate-900 border border-slate-800 rounded-3xl p-8 shadow-2xl text-center space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2">
              <button
                ...
                className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-slate-800 hover:bg-slate-750 text-white text-xs sm:text-sm font-semibold border border-slate-700 transition cursor-pointer"
              >

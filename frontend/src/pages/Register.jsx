    ...
    <div className="max-w-md w-full mx-auto my-8 sm:my-12 px-2 sm:px-4">
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-xs font-semibold uppercase tracking-wider text-slate-700 dark:text-slate-300 mb-1.5">
              Full Name <span className="text-slate-400 dark:text-slate-500 text-[10px] font-normal">(Optional)</span>
            </label>
            <input
              type="text"
              name="name"
          ...
          <div>
            <label className="block text-xs font-semibold uppercase tracking-wider text-slate-700 dark:text-slate-300 mb-1.5">
              Username <span className="text-emerald-600 dark:text-emerald-400">*</span>
            </label>
            <input
              type="text"
              name="username"
          ...
          <div>
            <label className="block text-xs font-semibold uppercase tracking-wider text-slate-700 dark:text-slate-300 mb-1.5">
              Password <span className="text-emerald-600 dark:text-emerald-400">*</span> <span className="text-slate-400 dark:text-slate-500 text-[10px] font-normal">(min 8 chars)</span>
            </label>
            <input
              type="password"
              name="password"
        ...
        <div className="mt-6 pt-6 border-t border-slate-200 dark:border-slate-800 text-center text-xs text-slate-500 dark:text-slate-400">
          ...
          <Link to="/login" className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-500 dark:hover:text-emerald-300 font-bold">
            Sign in
          </Link>
        </div>
      </div>

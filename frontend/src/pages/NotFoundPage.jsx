  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] text-center px-4 py-12">
      <div className="relative mb-6">
        <div className="w-24 h-24 rounded-3xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 flex items-center justify-center mx-auto shadow-2xl shadow-emerald-500/10">
          <span className="text-4xl font-extrabold font-mono tracking-tighter">404</span>
        </div>
        <div className="absolute -top-2 -right-2 px-2 py-0.5 rounded-full bg-slate-800 border border-slate-700 text-[10px] font-mono text-slate-400">
          LOST ROUTE
        </div>
      </div>
      ...
      <div className="flex flex-wrap items-center justify-center gap-3 mb-8">
        ...
        <Link
          to="/"
          className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-slate-800 hover:bg-slate-750 text-slate-200 hover:text-white border border-slate-700 text-xs sm:text-sm font-semibold transition cursor-pointer"
        >
      ...
      <div className="pt-6 border-t border-slate-800/80 w-full max-w-sm">
        ...
        <div className="flex justify-center gap-3">
          <Link
            to="/workouts"
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-900 border border-slate-800 text-xs text-slate-300 hover:text-emerald-400 transition"
          >
